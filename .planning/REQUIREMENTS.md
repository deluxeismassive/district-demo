...
- [ ] **FOUND-01**: App has multi-page SPA routing with a persistent sidebar nav linking all sections
...
- [ ] **FOUND-04**: Pinia store manages shared tag state accessible across all pages
