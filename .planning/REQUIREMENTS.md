...
- [ ] **LAYOUT-01**: Persistent app shell implemented as `app/layouts/default.vue` with dark sidebar nav; `NuxtLink` replaces `RouterLink`; active route highlighting works on all pages
