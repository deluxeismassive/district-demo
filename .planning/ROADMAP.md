...
Plans:
- [x] 12-01-PLAN.md — Risk Position page: 3-way useFetch join (vendors+dpa+edtech), tier derivation, ECharts donut (initial-SSR, NO ClientOnly per STATE.md), sortable UTable with RISK_TIER_COLORS :style UBadge tiers, page-level VendorDrawer mount
